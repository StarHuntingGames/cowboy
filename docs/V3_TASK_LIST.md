...
| BOT-012 | Implement command generation with DeepAgents (`move`, `shoot`, `shield`, `speak`) | DONE | DONE | DONE | DeepAgents-backed Python decision path with strict normalization and fallback; observed bot `speak`/turn progression in headless E2E. |
